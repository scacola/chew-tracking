...
export const ja: Copy = {
  ...
  hero: {
    ...
    title: ['気づくと、昼食がすぐ終わっている。', 'AirPodsで、食べる速さを見える化。'],
    accents: ['AirPods', '見える化'],
    bodyDesktop: [
  ...
  problem: {
    ...
    evidence: [
      ...
      },
      {
        ...
        accent: '大きく変える前に、見える化。',
        source: '— Chew & Calm Coach ベータ版',
      },
    ],
    quotes: [
      { quote: '気づくと、昼食がいつもすぐ終わっています。', label: '佐藤 健太 (早食い, 34歳)' },
      { quote: '食べる量だけでなく、速さにも目を向けたい。', label: '中村 美咲 (食事ペース, 29歳)' },
      { quote: '大きく変える前に、毎日の食べ方から整えたい。', label: '山本 誠 (習慣づくり, 43歳)' },
    ],
  ...
  demo: {
    ...
    body: ['AirPodsのモーションデータから食事中の動きを推定し、', '食べる速さやペースの変化を見える化します。', 'ベータ版では精度を検証中です。'],
    rows: [
  ...
  differentiation: {
    ...
    cards: [
      { id: 'c', size: 'lg', accent: 'clinical', title: '食事ペースの見える化', body: '噛む回数だけを数えるのではなく、食べる速さと変化に気づくための設計です。' },
    ...
    closing: '大きく変える前に、まずは食べる速さを見える化。',
  },
  trust: {
  ...
  finalCta: {
    title: ['気づくと、昼食がすぐ終わっている。', 'まずは食べる速さを見える化してみませんか。'],
    datePrefix: '',
